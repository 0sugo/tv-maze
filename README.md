...
**[TV Maze App]** gets data from the tv maze API and displays the data along with show images. It also allows you to add comments to the specific shows displayed. All data is preserved thanks to the external<a href="https://www.tvmaze.com/api"> TV MAZE API</a>.
...
<summary>Technologies</summary>
  <ul>
    ...
    <li><a href="https://www.tvmaze.com/api">API</a></li>
  </ul>
</details>
